                        ...
                        <div class="mb-4">
                            ...
                            <select name="id_orientadores" id="id_orientadores" 
                                ...
                                @foreach($orientadores as $orientador)
                                    <option value="{{ $orientador->id }}" {{ old('id_orientadores', $banca->id_orientadores) == $orientador->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="id_titulos" id="id_titulos" 
                                ...
                                @foreach($titulos as $titulo)
                                    <option value="{{ $titulo->id }}" {{ old('id_titulos', $banca->id_titulos) == $titulo->id ? 'selected' : '' }}>
                                        {{ $titulo->dsc_titulo }}
                                    </option>
                                @endforeach
                            </select>
